...
export default function CreateCategory() {
  useInitNavStackOnce([
    { title: "Create Brand", path: "/admin/categories/create" },
  ]);
  ...
  const createMutation = useMutation({
    mutationFn: async (payload: {
      ...
      const response = await fetch(API_ROUTES.ADMIN.CREATE_CATEGORY, {
        method: "POST",
        headers: {
    ...
    onSuccess: () => {
      router.goto(1); // Go back to Categories in nav stack
    },
    onError: (error) => {
      setErrors({
        submit:
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-3 py-6">
          ...
          <div>
            ...
            >
              Add a new Brand to your course library
            </p>
          </div>
        </div>
